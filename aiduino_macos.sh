#!/bin/bash
# AI.duino v1.2.0 - macOS - Easy Install
# Copyright 2025 Monster Maker
# Licensed under Apache License 2.0

echo ""
echo "==============================================="
echo "   AI.duino v1.2.0 - macOS Installer"
echo "==============================================="
echo ""
...
for dir in \
    ...
    "/Applications/Arduino.app/Contents/Resources/app/plugins" \
    "$HOME/Applications/Arduino IDE.app/Contents/Resources/app/plugins" \
    "$HOME/Applications/Arduino.app/Contents/Resources/app/plugins" \
    "/Applications/Arduino IDE 2.app/Contents/Resources/app/plugins"; do
    if [ -d "$dir" ]; then
        PLUGIN_DIR="$dir"
        FOUND_PATH="$dir"
        break
...
if [ -z "$PLUGIN_DIR" ]; then
    ...
    echo "/Applications/Arduino IDE.app/Contents/Resources/app/plugins/aiduino"
    echo ""
    exit 1
fi
...
<PackageManifest Version="2.0.0" xmlns="http://schemas.microsoft.com/developer/vsx-schema/2011">
  <Metadata>
    <Identity Language="en-US" Id="aiduino" Version="1.2.0" Publisher="Monster Maker"/>
